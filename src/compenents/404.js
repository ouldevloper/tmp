...
const _404 = ()=>{
    ...
    <div class="text">
      ...
      <h2  style={{color:"white"}}>Couldn't launch :(</h2>
         <h3  style={{color:"white"}}>Page Not Found - lets take you <Button danger  style={{backgroundColor:"black"}} onClick={back}>Back</Button></h3> 
    </div>
    </>;
}
